...
int main() {
    ...
    struct PoliceStation police_stations[] = {
        {"Downtown", "123-456-7890"},
        {"Uptown", "987-654-3210"},
        {"Suburbs", "555-123-4567"},
        {"Eastside", "555-765-4321"}
    };
    int police_size = sizeof(police_stations) / sizeof(police_stations[0]);

    
    struct Hospital hospitals[] = {
        {"Downtown", "Private", "City Care Hospital", "111-222-3333"},
        {"Uptown", "Government", "Uptown Government Hospital", "444-555-6666"},
        {"Suburbs", "Private", "Suburban Health Clinic", "777-888-9999"},
        {"Eastside", "Government", "Eastside General Hospital", "555-123-4567"},
        {"Downtown", "Government", "Downtown Public Hospital", "222-333-4444"},
        {"Uptown", "Private", "Uptown Private Care", "999-888-7777"}
    };
    int hospital_size = sizeof(hospitals) / sizeof(hospitals[0]);

    
    struct FireStation fire_stations[] = {
        {"Downtown", "333-444-5555"},
        {"Uptown", "555-666-7777"},
        {"Suburbs", "888-999-0000"},
        {"Eastside", "123-456-7891"}
    };
